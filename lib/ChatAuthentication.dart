...
class ChatAuthenticationPage extends StatefulWidget {
  @override
  _ChatAuthenticationPageState createState() => _ChatAuthenticationPageState();
}

class _ChatAuthenticationPageState extends State<ChatAuthenticationPage> {
